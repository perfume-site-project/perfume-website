...
const SignUp = ({requestPost}) => {
  ...
  const checkBox = () => {
    const checkbox = checkedButtons.includes('ageCheck') && checkedButtons.includes('agreeCheck') && checkedButtons.includes('personalCheck');
    if(checkbox === false){
  ...
  return (
    <section className={styles.findId}>
      ...
      <div className={styles.container}>
        ...
        <br></br>
        <input type="checkbox" id="personalCheck"
          onChange={e => {
