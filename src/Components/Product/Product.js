    ...
    <Wrapper>
      ...
      <section className={styles.productInfo}>
        ...
        <div className={styles.review} ref={div4}>
          <button className={styles.review_button} onClick={handleReviewButton}>
            리뷰 참여하기
          </button>
          ...
          <div>
            {showModal && <WriteReview requestPost={requestPost} id={product["_id"]} setShowModal={setShowModal} />}
          </div>
        </div>
      </section>
    </Wrapper>
