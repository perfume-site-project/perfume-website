      ...
      <div className={styles.modal}>
        <div className={styles.review}>
          ...
          <div className={styles.score}>
            <img
              src={state.score >= 1 ? filled_star : empty_star}
              alt=""
              onClick={() => {
            ...
            />
            <img
              src={state.score >= 2 ? filled_star : empty_star}
              alt=""
              onClick={() => {
                setState({ ...state, score: 2 });
              }}
            />
            <img
              src={state.score >= 3 ? filled_star : empty_star}
              alt=""
              onClick={() => {
                setState({ ...state, score: 3 });
              }}
            />
            <img
              src={state.score >= 4 ? filled_star : empty_star}
              alt=""
              onClick={() => {
                setState({ ...state, score: 4 });
              }}
            />
            <img
              src={state.score >= 5 ? filled_star : empty_star}
              alt=""
              onClick={() => {
                setState({ ...state, score: 5 });
              }}
            />
          </div>
